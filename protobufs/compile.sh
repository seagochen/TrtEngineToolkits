...
# 目標のフォルダを作成
PYTHON_PROTOBUF_FOLDERS=("displayer/protobufs")
CPP_PROTOBUF_FOLDERS=("jetson/extend/protobufs")
...
echo "Protobuf files have been copied to displayer and jetson, and output directories have been deleted."
