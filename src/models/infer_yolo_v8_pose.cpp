...
InferYoloV8Pose::InferYoloV8Pose(
    ...
    LOG_VERBOSE_TOPIC("InferYolov8Pose", "constructor", "InferYoloObjectv8 object created successfully.");
    ...
    LOG_VERBOSE_TOPIC("InferYolov8Pose", "constructor", "Local buffer allocated successfully.");
    ...
    g_vec_outputBuffer.push_back(createZerosTensor<TensorType::FLOAT32>(g_int_outputFeatures, g_int_outputSamples));
    LOG_VERBOSE_TOPIC("InferYolov8Pose", "constructor", "Temporary buffer for CUDA computation allocated successfully.");
}
...
InferYoloV8Pose::~InferYoloV8Pose() {
    ...
    LOG_VERBOSE_TOPIC("InferYolov8Pose", "deconstructor", "InferYolov8Pose object destroyed successfully.");
}
